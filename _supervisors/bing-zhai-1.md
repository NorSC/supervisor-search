...
additional_details: >-
  ...
  **Sleep and Fatigue Monitoring Using Wearable Sensing Technologies (The IDEA-FAST Project)**
  ...
  The goal is to identify, profile and validate digital solutions based on mobile or residential technology for remote assessment of fatigue and sleep disturbances that could effectively be used as digital endpoints in assessments for RA, SLE, PSS, IBD, PD, HD and beyond.


  The project will be to develop an ML/DL models that can detect fatigue/non-fatigue or predict a fatigue score efficiently. Ideally, the system should be also capable of interpreting the decision-making process. ECG, Heart Rate, accelerometery and gyroscope data will be used to develop the algorithms. The AI-based algorithms can also be used to explain the prediction results to clinicians so that the AI model is more transparent.


  For more information, please visit: [](https://idea-fast.eu/patient-information/)<https://idea-fast.eu>
